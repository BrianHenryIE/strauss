...
EOD;
        ...
        // Expected anyway.
        $this->assertTrue($this->getFileSystem()->fileExists($this->testsWorkingDir . '/vendor-prefixed/freemius/wordpress-sdk/start.php'));
        // Not part of the autoloader.
        $this->assertTrue($this->getFileSystem()->fileExists($this->testsWorkingDir . '/vendor-prefixed/freemius/wordpress-sdk/config.php'));
...
EOD;
        ...
        $this->assertTrue($this->getFileSystem()->fileExists($this->testsWorkingDir . '/vendor-prefixed/woocommerce/action-scheduler/action-scheduler.php'));
...
EOD;
        ...
        $this->assertTrue($this->getFileSystem()->fileExists($this->testsWorkingDir . '/vendor-prefixed/yahnis-elsts/plugin-update-checker/plugin-update-checker.php'));
...
EOD;
        ...
        $this->assertTrue($this->getFileSystem()->fileExists($this->testsWorkingDir . '/vendor-prefixed/wordpress/abilities-api/includes/abilities-api.php'));
